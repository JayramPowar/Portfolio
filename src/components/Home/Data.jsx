...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Jayram Powar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">BTech Data Science student and Technical Head at the AI & Robotics Club. I lead technical initiatives and work on innovative projects in AI and robotics, combining leadership with a passion for technology.</p>
